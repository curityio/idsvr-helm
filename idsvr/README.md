...
`curity.admin.service.annotations`| Extra annotations for the Admin Service resource |`{}`
...
`curity.runtime.service.annotations`| Extra annotations for the Runtime Service resource |`{}`

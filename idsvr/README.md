...
`curity.config.encryptionKey`| The configuration encryption key                                                                                                              |`[]]`
`curity.config.environmentVariableSecrets`| The data from this array of Secret names will be mounted as environment variables                                                             |`[]]` 

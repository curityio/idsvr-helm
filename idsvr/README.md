...
| `curity.config.fipsMode`                                  | Flag to enable/disable FIPS mode (`--fips-mode`). Requires a special license and FIPS enabled docker image, contact [sales@curity.io](sales@curity.io) for more details.                                                                               | `false`                          |

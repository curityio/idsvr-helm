...
| `curity.config.environmentVariableSecrets`          | The data from this array of Secrets will be mounted as environment variables                                                                  | `[]`                             |
| `curity.config.environmentVariableConfigMaps`       | The data from this array of ConfigMaps will be mounted as environment variables                                                               | `[]`                             |
